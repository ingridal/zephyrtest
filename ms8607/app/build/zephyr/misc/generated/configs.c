...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_TE_MS8607H_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_TE_MS8607PT_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ZEPHYR_BT_HCI_ENTROPY_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MS8607, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MS8607_HUMIDITY, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MS8607_PRESSURE_TEMPERATURE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MS8607_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MS8607_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_MS8607_MODULE, 1);
